...
db = pg8000.connect(database='d5i4dbpff3htlh', user='dpqajkuapfamfg', password='25a37c8cb43391f3d8b987fc278a4e363cd930a3a0d2acfe7a96ba2bf2f0709f', host='18.204.74.74', port='5432')
app = Flask(__name__)
CORS(app)
